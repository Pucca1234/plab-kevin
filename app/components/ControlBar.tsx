...
type ControlBarProps = {
  ...
  onDuplicateTemplate: (template: FilterTemplate | null) => void;
        ...
        <div className="search-row search-row-main search-row-secondary">
          ...
          <div className="search-actions-stack">
            <button
                ...
                onClick={() => {
                  const active = activeTemplateId ? templates.find((t) => t.id === activeTemplateId) ?? null : null;
                  onDuplicateTemplate(active);
                }}
                title="현재 템플릿 복제"
              >
